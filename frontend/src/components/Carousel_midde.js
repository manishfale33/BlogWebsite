...
export default function Carousel_midde() {
  ...
  return (
    <div>
      {blogmodels.map((item) => (
        <div key={item.id} className="relative w-[450px] rounded-b-lg">
          <img src={item.image} alt="" className='h-[408px] w-full ml-14 rounded-lg' />
