...
const Litebet = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(carouselItems[0]);
  const [currentSlide, setCurrentSlide] = useState(0);
  const [likes, setLikes] = useState(Array(carouselItems.length).fill(0));
