...
export default function HomeHeading() {
    ...
    return (
        ...
        // </div>
        <div>
            <p className=' text-sm lg:ml-24 sm:mt-10 tracking-tight '>Home &gt; Our top stories</p>
            <h1 className=' text-2xl lg:ml-24 sm:mt-4 sm:text-4xl text-[#196562] font-bold underline decoration-solid tracking-wide text-font_color '>Our Top Stories</h1>
